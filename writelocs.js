function getSelectedRegion() {
  var selectedRegionName = document.getElementById("SelectedRegion").innerHTML;
  selectedRegionName = "regions/" + selectedRegionName + ".xml";

  var regionData = loadXMLDoc(selectedRegionName);
  return regionData;
}
...
//Writes a series of 1, 2, 3, or 4 columns with (25, 33, 50, and 100% width) to the HTML document.
